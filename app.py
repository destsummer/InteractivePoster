...
def create_poster():
    ...
    my_poster.add_section(title="Interactive Figures",
        ...
        img1={"filename":"Topic_9_male2.html", "height":"5.25in", "width":"10in", "caption":"Example topic when processing the history section for male patients. This topic appears to be related to the heart indicated by top weighted words 'cardiac', 'coronary' and 'aortic'. Total word count and word weight is projected."},
    ...
    my_poster.add_section(title="Current Work",
        ...
        img4={"filename":"clever_flow.png", "height":"5.25in", "width":"10in", "caption":""}) 
    my_poster.add_section(title="Clever Output",
        img5={"filename":"clever_output.png", "height":"5.25in", "width":"10in", "caption":""})
