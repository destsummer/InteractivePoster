...
def create_poster():
    ...
    my_poster.add_section(title="Abstract",
    	...
    	img0={"filename":"death_causes.png", "height":"5.75in", "width":"10in", "caption":" CDC’s National Center for Health Statistics, https://www.nimh.nih.gov/health/statistics/suicide.shtml"})
    ...
    my_poster.add_section(title="Current Work",
        ...
        img3={"filename":"clever_flow.png", "height":"7.25in", "width":"10in", "caption":"Flowchart of CLEVER."}) 
