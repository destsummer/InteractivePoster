...
def create_poster():
    ...
    my_poster.add_section(title="Abstract",
    	...
    	img0={"filename":"death_causes.png", "height":"5in", "width":"8in", "caption":" CDC’s National Center for Health Statistics, https://www.nimh.nih.gov/health/statistics/suicide.shtml"})
    ...
    my_poster.add_section(title="Preliminary Work",
        text="Latent Dirichlet Allocation (LDA) is a statistical model that finds topics in free format text. Our LDA Topic models were trained using MIMIC-III discharge notes and various Python packages known as NLTK and Gensim, which include the use of Bag-of-Words and Term Frequency-Inverse Document Frequency (TF-IDF).")
    ...
    my_poster.add_section(title="Interactive Figures",
        ...
        img1={"filename":"Topic_9_male2.html", "height":"5.25in", "width":"10in", "caption":"Example topic when processing the history section of male patient notes. This topic appears to be related to the heart indicated by top weighted words 'cardiac', 'coronary' and 'aortic'. Total word count and word weight is projected."},
        img2={"filename":"SA_History_dis.html", "height":"5.25in", "width":"10in", "caption":"Frequency of dominant topics and weighted topics found within the history section of both male and female suicide attempt patient notes. Dominant topic means only the highest scoring probability for each note is recorded. Topic weightage means that all probabilities for notes are accumulative."},
        pyLDA={"filename":"full_lda_html.html", "height":"7in", "width":"12in", "caption": "Figure 3 LDA topics and their corresponding word frequency and weight. Multidmensional Scaling (MDS) gives an estimate of similarity between the topics. Relevance metric can be adjusted to effect saliency and relevance."})
    ...
    my_poster.add_section(title="Current Work",
        ...
        img3={"filename":"clever_flow.png", "height":"6in", "width":"10in", "caption":"Flowchart of CLEVER."}) 
