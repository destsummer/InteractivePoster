...
def create_poster():
    ...
    my_poster.add_section(title="Conclusion", text="NLP allows for the extraction of concepts and topics that are hidden within EHR free text data. These LDA models were successful at identifying topics related to diagnosis, procedures, routines and more. They were also successful at identifying socio-economic determinants like drug abuse. Using these results, future implementation on the CDW of the VA can identify those who are at higher risk of suicide. Further development and refining, including the use of an NLP tool called Clever, is ongoing.")
    my_poster.add_section(title="Acknowledgments", text="This work was supported in part by the U.S. Department of Energy, Computational Research Division (CRD) of the Berkeley National Lab, and VA Million Veteran Program (MVP). Thank you again to Dr. Liu, Dr. Crivelli, Rafael, and Shirley. Thank you to Dr. Tamang at ORNL for sharing her clinical concept extractor, Clever.") 
    my_poster.next_column()
