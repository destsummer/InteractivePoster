...
def Header(title, authors, institutions, logo, banner_color):
    layout = dbc.Card(
    dbc.Row(
    [dbc.Col(html.Img(src="SHI.png", style={'height':'2in', "width":"5in"}),style={"display":"flex","justify-content":"flex-end","padding-left":"50px"},width=1.5),
     dbc.Col([dbc.Row(html.Img(src="logo1.png", style={'height':'1.75in', "width":"5in","padding-left":"30px"})),
              dbc.Row(html.Img(src="logo2.png", style={'height':'1.75in', "width":"5in", "padding-left":"30px"}))],width=1.5),
     dbc.Col([
